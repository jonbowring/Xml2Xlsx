...
Picture|XML
-----|-----------
<img src="https://github.com/jonbowring/Xml2Xlsx/blob/readme-v1/examples/example1.png?raw=true" width="300" style="width: 300 !important;" alt="A Simple Table With Auto Filters"/>|```<workbook> <worksheet name="Books" autofilter="true"> <row> <cell>Title</cell> <cell>Author</cell> <cell>Year</cell> <cell>Price</cell> </row> <row> <cell>Everyday Italian</cell> <cell>Giada De Laurentiis</cell> <cell>2005</cell> <cell>30.00</cell> </row> <row> <cell>Harry Potter</cell> <cell>J K. Rowling</cell> <cell>2005</cell> <cell>29.99</cell> </row> <row> <cell>XQuery Kick Start</cell> <cell>Vaidyanathan Nagarajan</cell> <cell>2003</cell> <cell>49.99</cell> </row> <row> <cell>Learning XML</cell> <cell>Erik T. Ray</cell> <cell>2003</cell> <cell>39.95</cell> </row> </worksheet> </workbook>```